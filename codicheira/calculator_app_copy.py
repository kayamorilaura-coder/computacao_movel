...
"""
@ft.control -> Decorador do flet que pega a classe que iremos criar 
e permite que utilizemos essa classe como se fosse um 
controle do flet, ou seja, é como se estivessemos criando
novos controles para essa framework;

ft.Container -> Herda do container atributos como tamanho, padinação...

self. -> São construtores da classe o método init trabalha como o __init__
de pyhton;
"""
@ft.control 
class CalculatorApp(ft.Container):
    def init(self):
        self.reset() # zera o estado interno
        #aparencia do container
        self.width = 350  
        self.bgcolor = ft.Colors.BLACK
        self.border_radius = ft.BorderRadius.all(20)
        self.padding = 20
        # fim
        self.result = ft.Text(value="0", color=ft.Colors.WHITE, size=20) # valor atual do display
        """
        Conteúdo que irá aparecer nesse container CalculatorApp 
        coloca em colunas (vertical) um embaixo do outro, ou seja, 
        o display vem em cima e abaixo vem todas as linhas
        """
